...
class HighResolutionModule(nn.Module):
    ...
    @staticmethod
    def _check_branches(num_branches, blocks, num_blocks, num_inchannels, num_channels):
...
class HighResolution(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.init_weights(kwargs["pre_trained_pascal"])
    ...
    def init_weights(self, pre_trained):
        ...
        if os.path.isfile(pre_trained):
            ...
            pre_trained_dict = {
                k: v for k, v in pre_trained_dict.items() if k in model_dict.keys()
            }
